...
//additional credit to Drew Baker on StackOverflow, original post http://stackoverflow.com/questions/4380105/html5-video-scale-modes
   ...
   var sxsw = {
   	...
   	full_width: function(boxWidth, boxHeight, imgWidth, imgHeight) {
...
jQuery(document).ready(function($) {       
     ...
     */
	 ...
	 function recalculateFills() {
		...
		//calculate new size
        // var new_size = sxsw.full_bleed(browserWidth, browserHeight, videosWidth, videoHeight);
        var new_size = sxsw.full_width(browserWidth, browserHeight, videoWidth, videoHeight);
